...
export class jsTreeWidget extends Component {
    ...
    */
    _onChangeTree(jsTreeAnchor) {
        ...
        this.props.update(currentValue);
    }
};

jsTreeWidget.supportedTypes = ["char"];
jsTreeWidget.template = "cloud_base.jsTreeWidget";
jsTreeWidget.props = { ...standardFieldProps };
