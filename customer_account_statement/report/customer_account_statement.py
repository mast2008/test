...
class CustomerAccountStatement(models.AbstractModel):
    """Model of Outstanding Statement"""

    _inherit = "customer.account.statement.common"
    _name = "report.customer_account_statement.customer_account_statement"
    ...
    def _display_lines_sql_q1(self, partners, date_end, account_type):
        ...
        return str(
            self._cr.mogrify(
                """
            SELECT l.id as move_line, m.name AS move_id, l.partner_id, l.date, l.name,
        ...
        return str(
            self._cr.mogrify(
                ...
                SELECT Q1.partner_id, Q1.currency_id, Q1.move_id,
                    ...
                    Q1.name, Q1.ref, Q1.blocked, Q1.company_id, q1.move_line,
    ...
    def _get_account_display_lines(
        ...
        SELECT partner_id, currency_id, move_id, date, date_maturity, debit,
                            credit, amount, open_amount, name, ref, blocked, move_line
        FROM Q3
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if "company_id" not in data:
            wiz = self.env["customer.account.statement.wizard"].with_context(
